    ...
    def decode(self, string):
        ...
        while i < len(string):
            if string[i:i + 1] in self.bytes_to_unicode:
                ...
                raise RedactionException('Cannot decode string using bytes_to_unicode generated by pdf_redactor.py')
        return "".join(ret)
    ...
    for pattern, function in options.content_filters:
        ...
        while i1 < i2:
            ...
            while text_tokens_index < len(text_tokens) and \
                                        ...
                                        text_tokens[text_tokens_index].value) - text_tokens_token_xdiff <= i1:
