...
BORDER_FROM_BOTTOM_OF_PAGE = 5.0 - 1.0
BORDER_FROM_TOP_OF_PAGE = 5.0 - 1.0
...
# service address is the area on the right of the address, often used for service address and contact details
SERVICE_ADDRESS_LEFT_FROM_LEFT_OF_PAGE = 125.0 - 1.0
SERVICE_ADDRESS_BOTTOM_FROM_TOP_OF_PAGE = 95.00 - 1.0

# address is the area inside the window of the envelope
ADDRESS_TOP_FROM_TOP_OF_PAGE = 39.50 - 1.0
...
# logo area is the valid area above the address
LOGO_LEFT_FROM_LEFT_OF_PAGE = BORDER_FROM_LEFT_OF_PAGE
LOGO_RIGHT_FROM_LEFT_OF_PAGE = SERVICE_ADDRESS_LEFT_FROM_LEFT_OF_PAGE
LOGO_BOTTOM_FROM_TOP_OF_PAGE = 30.00 + 1.0
LOGO_TOP_FROM_TOP_OF_PAGE = BORDER_FROM_TOP_OF_PAGE
